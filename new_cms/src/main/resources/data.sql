INSERT INTO QSRanking (QS_ranking_id,Qs_rank, Institution_Name, Location, Academic_Reputation_Score, Employer_Reputation_Score, Faculty_Student_Score, Citations_per_Faculty_Score, International_Faculty_Score, International_Students_Score, International_Research_Network_Score, Employment_Outcomes_Score, Overall_Score)VALUES
    ('Q1','1','Massachusetts Institute of Technology ','United States',100,100,100,100,100,90,96.1,100,100),
    ...
    ('Q6','6=','California Institute of Technology ','United States',96.5,87.1,100,100,99.8,85.1,73,98.8,97),
    ...
    ('Q11','11','National University of Singapore ','Singapore',99.5,94.1,79.8,91.8,100,73.5,89.9,99.6,92.7),
    ...
    ('Q26','26','University PSL','France',74.4,97,99.8,84.1,59.7,83.6,99.7,53.9,83.8),
    ('Q27','27','University of California, Berkeley ','United States',100,100,23.9,99.9,93.3,57.7,96.7,99.1,82.7),
    ...
    ('Q38','38','The Chinese University of Hong Kong ','Hong Kong SAR',87.3,49.6,60.9,92.9,100,90.5,74.9,79.4,80.6),
    ('Q39','39','New York University ','United States',95.9,99,98.1,28.9,31.3,94.4,92,99.7,80.3),
    ...
    ('Q45','45','The University of New South Wales ','Australia',89,91.1,16.8,97.6,100,99.8,98.2,93,78),
    ...
    ('Q77','77','National Taiwan University ','Taiwan',92.3,92.6,33.4,49.7,19,32.6,75,96.7,65.7),
    ...
    ('Q99','99','Sungkyunkwan University','South Korea',60.2,72.7,83.9,37.8,18.9,38.7,58.8,33.9,58.9),
...
INSERT INTO universities(universityId,uniName,qs_id,cwur_id,times_id) VALUES
 ('AU001','Massachusetts Institute of Technology ','Q1','C3','T5'),
    ('AU002','University of Cambridge','Q2','C4','T4'),
    ('AU003','Stanford University','Q3','C2','T3'),
    ('AU004','University of Oxford','Q4','C5','T2'),
    ('AU005','Harvard University','Q5','C1','T6'),
    ('AU006','California Institute of Technology ','Q6','C12','T1'),
    ('AU007','Imperial College London','Q7','C35','T8'),
    ('AU008','UCL','Q8','C27','T14'),
    ('AU009','ETH Zurich - Swiss Federal Institute of Technology','Q9','C91','T9'),
    ('AU010','University of Chicago','Q10','C8','T10'),
    ('AU011','National University of Singapore ','Q11','C65','T26'),
    ('AU012','Peking University','Q12','C56','T42'),
    ('AU013','University of Pennsylvania','Q13','C14','T17'),
    ('AU014','Tsinghua University','Q14','C78','T47'),
    ('AU015','The University of Edinburgh','Q15','C55','T24'),
    ('AU016','EPFL','Q16','C63','T31'),
    ('AU017','Princeton University','Q17','C9','T7'),
    ('AU018','Yale University','Q18','C11','T12'),
    ('AU019','Nanyang Technological University, Singapore (NTU)','Q19','C135','T55'),
    ('AU020','Cornell University','Q20','C10','T18'),
    ('AU021','The University of Hong Kong','Q21','C170','T59'),
    ('AU022','Columbia University','Q22','C6','T15'),
    ('AU023','The University of Tokyo','Q23','C13','T43'),
    ('AU024','Johns Hopkins University','Q24','C16','T11'),
    ('AU025','University of Michigan-Ann Arbor','Q25','C19','T199'),
    ('AU026','Université PSL','Q26','NA','NA'),
    ('AU027','University of California, Berkeley (UCB)','Q27','C7','T13'),
    ('AU028','The University of Manchester','Q28','C67','T56'),
    ('AU029','Seoul National University','Q29','C24','T85'),
    ('AU030','The Australian National University','Q30','C179','T52'),
    ('AU031','McGill University','Q31','C42','T38'),
    ('AU032','Northwestern University','Q32','C22','T25'),
    ('AU033','The University of Melbourne','Q33','C93','T33'),
    ('AU034','Fudan University','Q34','C195','NA'),
    ('AU035','University of Toronto','Q35','C32','T19'),
    ('AU036','Kyoto University','Q36','C17','T88'),
    ('AU037','King''s College London','Q37','C94','NA'),
    ('AU038','The Chinese University of Hong Kong ','Q38','NA','T139'),
    ('AU039','New York University ','Q39','C18','T30'),
    ('AU040','The Hong Kong University of Science and Technology','Q40','NA','T59'),
    ('AU041','The University of Sydney','Q41','C88','T57'),
    ('AU042','KAIST - Korea Advanced Institute of Science & Technology','Q42','C144','T149'),
    ('AU043','Zhejiang University','Q43','C191','NA'),
    ('AU044','University of California, Los Angeles (UCLA)','Q44','C15','T16'),
    ('AU045','The University of New South Wales ','Q45','C130','T83'),
    ('AU046','Shanghai Jiao Tong University','Q46','C180','NA'),
    ('AU047','University of British Columbia','Q47','C62','T34'),
    ('AU048','Institut Polytechnique de Paris','Q48','NA','NA'),
    ('AU049','Technical University of Munich','Q49','C101','T53'),
    ('AU050','Duke University','Q50','C28','T20'),
    ('AU051','The University of Queensland','Q51','C103','T60'),
    ('AU052','Carnegie Mellon University','Q52','C61','T22'),
    ('AU053','University of California, San Diego (UCSD)','Q53','C21','T39'),
    ('AU054','City University of Hong Kong','Q54','NA','NA'),
    ('AU055','Tokyo Institute of Technology (Tokyo Tech)','Q55','C109','NA'),
    ('AU056','The London School of Economics and Political Science (LSE)','Q56','NA','NA'),
    ('AU057','Monash University','Q57','C145','T73'),
    ('AU058','University of Amsterdam','Q58','C114','T58'),
    ('AU059','Ludwig-Maximilians-Universität München','Q59','C155','NA'),
    ('AU060','Sorbonne University','Q60','NA','NA'),
    ('AU061','Delft University of Technology','Q61','NA','T65'),
    ('AU062','University of Bristol','Q62','C123','T69'),
    ('AU063','Brown University','Q63','C83','T51'),
    ('AU064','The University of Warwick','Q64','NA','T80'),
    ('AU065','Ruprecht-Karls-Universität Heidelberg','Q65','C76','NA'),
    ('AU066','The Hong Kong Polytechnic University','Q66','NA','T59'),
    ('AU067','Universidad de Buenos Aires (UBA)','Q67','NA','NA'),
    ('AU068','Osaka University','Q68','C45','NA'),
    ('AU069','Université Paris-Saclay','Q69','NA','NA'),
    ('AU070','Universiti Malaya (UM)','Q70','NA','NA'),
    ('AU071','Pohang University of Science And Technology (POSTECH)','Q71','C165','T117'),
    ('AU072','University of Texas at Austin','Q72','C30','T46'),
    ('AU073','Yonsei University','Q73','C98','NA'),
    ('AU074','Korea University','Q74','C115','NA'),
    ('AU075','Lomonosov Moscow State University','Q75','C59','T161'),
    ('AU076','KU Leuven','Q76','NA','T35'),
    ('AU077','National Taiwan University (NTU)','Q77','C57','T169'),
    ('AU078','University of Southampton','Q78','C148','T112'),
    ('AU079','Tohoku University','Q79','C73','NA'),
    ('AU080','University of Washington','Q80','NA','T32'),
    ('AU081','University of Glasgow','Q81','C128','T76'),
    ('AU082','University of Copenhagen','Q82','C74','T82'),
    ('AU083','University of Wisconsin-Madison','Q83','NA','T50'),
    ('AU084','University of Zurich','Q84','C96','T105'),
    ('AU085','University of Illinois at Urbana-Champaign','Q85','NA','T36'),
    ('AU086','University of Leeds','Q86','C161','T135'),
    ('AU087','The University of Auckland','Q87','NA','NA'),
    ('AU088','Georgia Institute of Technology','Q88','C80','T41'),
    ('AU089','KTH Royal Institute of Technology','Q89','NA','T155'),
    ('AU090','The University of Western Australia','Q90','NA','NA'),
    ('AU091','University of Birmingham','Q91','C152','T120'),
    ('AU092','Durham University','Q92','NA','T70'),
    ('AU093','Pennsylvania State University','Q93','NA','T75'),
    ('AU094','University of Science and Technology of China','Q94','NA','NA'),
    ('AU095','Lund University','Q95','C117','T91'),
    ('AU096','The University of Sheffield','Q96','C173','T97'),
    ('AU097','University of St Andrews','Q97','NA','T86'),
    ('AU098','Trinity College Dublin, The University of Dublin','Q98','C185','T160'),
    ('AU099','Sungkyunkwan University(SKKU)','Q99','NA','T153'),
    ('AU100','Rice University','Q100','C120','T103'),
    ('AU101','University of Oslo','Q101','C99','T136'),
    ('AU102','University of California, Davis','Q102','C53','T44'),
    ('AU103','University of North Carolina, Chapel Hill','Q103','C40','T63'),
    ('AU104','Technical University of Denmark','Q104','C174','T170'),
    ('AU105','Universidad Nacional Autónoma de México (UNAM)','Q105','NA','NA'),
    ('AU106','King Abdulaziz University (KAU)','Q106','NA','NA'),
    ('AU107','University of Helsinki','Q107','C111','T77'),
    ('AU108','Boston University','Q108','C66','T64'),
    ('AU109','The University of Adelaide','Q109','NA','T150'),
    ('AU110','University of Alberta','Q110','C107','T138'),
    ('AU111','École Normale Supérieure de Lyon','Q111','NA','NA'),
    ('AU112','Nagoya University','Q112','C125','NA'),
    ('AU113','Utrecht University','Q113','C87','T62'),
    ('AU114','University of Nottingham','Q114','C140','T144'),
    ('AU115','Universidade de São Paulo','Q115','C132','NA'),
    ('AU116','Aalto University','Q116','NA','NA'),
    ('AU117','Université de Montréal','Q117','C151','T114'),
    ('AU118','Freie Universitaet Berlin','Q118','C147','T172'),
    ('AU119','Washington University in St. Louis','Q119','C52','NA'),
    ('AU120','University of Bern','Q120','C200','T121'),
    ('AU121','Pontificia Universidad Católica de Chile (UC)','Q121','NA','NA'),
    ('AU122','Newcastle University','Q122','NA','T196'),
    ('AU123','Universiti Putra Malaysia (UPM)','Q123','NA','NA'),
    ('AU124','Wageningen University & Research','Q124','NA','T48'),
    ('AU125','Chalmers University of Technology','Q125','NA','NA'),
    ('AU126','Queen Mary University of London','Q126','NA','T98'),
    ('AU127','University of Geneva','Q127','C92','T132'),
    ('AU128','Uppsala University','Q128','C124','T81'),
    ('AU129','Purdue University','Q129','NA','T116'),
    ('AU130','Universiti Kebangsaan Malaysia ','Q130','NA','NA'),
    ('AU131','Humboldt-Universität zu Berlin','Q131','C153','T49'),
    ('AU132','Leiden University','Q132','C108','T67'),
    ('AU133','Nanjing University','Q133','NA','NA'),
    ('AU134','University of Southern California','Q134','C51','T68'),
    ('AU135','Kyushu University','Q135','C100','NA'),
    ('AU136','University of Basel','Q136','C160','T101'),
    ('AU137','University of Technology Sydney','Q137','NA','NA'),
    ('AU138','Eindhoven University of Technology','Q138','NA','T176'),
    ('AU139','Politecnico di Milano','Q139','NA','NA'),
    ('AU140','The Ohio State University','Q140','C49','T92'),
    ('AU141','Hokkaido University','Q141','C178','NA'),
    ('AU142','KIT, Karlsruhe Institute of Technology','Q142','NA','T140'),
    ('AU143','Ghent University','Q143','C119','T119'),
    ('AU144','Universiti Sains Malaysia (USM)','Q144','NA','NA'),
    ('AU145','University of Groningen','Q145','C110','T74'),
    ('AU146','Lancaster University','Q146','NA','T131'),
    ('AU147','RWTH Aachen University','Q147','NA','T111'),
    ('AU148','University of Rochester','Q148','C81','T159'),
    ('AU149','University of California, Santa Barbara (UCSB)','Q149','C64','T40'),
    ('AU150','Al-Farabi Kazakh National University','Q150','NA','NA'),
    ('AU151','University of Vienna','Q151','NA','T143'),
    ('AU152','McMaster University','Q152','C150','T96'),
    ('AU153','Stockholm University','Q153','C168','T137'),
    ('AU154','University of Waterloo','Q154','NA','T179'),
    ('AU155','Emory University','Q155','C84','T90'),
    ('AU156','Indian Institute of Science','Q156','NA','NA'),
    ('AU157','Hanyang University','Q157','C192','NA'),
    ('AU158','Technische Universität Berlin (TU Berlin)','Q158','NA','NA'),
    ('AU159','Michigan State University','Q159','C118','T100'),
    ('AU160','King Fahd University of Petroleum & Minerals','Q160','NA','NA'),
    ('AU161','Aarhus University','Q161','C122','T106'),
    ('AU162','University of York','Q162','NA','T133'),
    ('AU163','The University of Exeter','Q163','NA','T93'),
    ('AU164','Texas A&M University','Q164','NA','T194'),
    ('AU165','University of Maryland, College Park','Q165','C72','T118'),
    ('AU166','Cardiff University','Q166','NA','T183'),
    ('AU167','Alma Mater Studiorum - University of Bologna','Q167','NA','NA'),
    ('AU168','Universidad de Chile','Q168','NA','NA'),
    ('AU169','Eberhard Karls Universität Tübingen','Q169','NA','NA'),
    ('AU170','Tecnológico de Monterrey','Q170','NA','NA'),
    ('AU171','Sapienza University of Rome','Q171','C112','NA'),
    ('AU172','Indian Institute of Technology Bombay (IITB)','Q172','NA','NA'),
    ('AU173','Western University','Q173','C133','NA'),
    ('AU174','Ecole des Ponts ParisTech','Q174','C104','NA'),
    ('AU175','Indian Institute of Technology Delhi (IITD)','Q175','NA','NA'),
    ('AU176','Case Western Reserve University','Q176','C105','T134'),
    ('AU177','National Tsing Hua University','Q177','NA','NA'),
    ('AU178','Universitat Autònoma de Barcelona','Q178','NA','T147'),
    ('AU179','Technische Universität Wien','Q179','NA','NA'),
    ('AU180','University of Bath','Q180','NA','NA'),
    ('AU181','Khalifa University of Science and Technology','Q181','NA','NA'),
    ('AU182','University College Dublin','Q182','NA','T177'),
    ('AU183','University of Pittsburgh','Q183','NA','T79'),
    ('AU184','Universitat de Barcelona','Q184','C116','T174'),
    ('AU185','University of Gothenburg','Q185','NA','T180'),
    ('AU186','University of Minnesota Twin Cities','Q186','C48','T66'),
    ('AU187','University of Wollongong','Q187','NA','NA'),
    ('AU188','University of Florida','Q188','C60','T123'),
    ('AU189','Albert-Ludwigs-Universitaet Freiburg','Q189','C155','NA'),
    ('AU190','RMIT University','Q190','NA','NA'),
    ('AU191','University of Liverpool','Q191','C199','T157'),
    ('AU192','The University of Newcastle, Australia (UON)','Q192','NA','T196'),
    ('AU193','Curtin University','Q193','NA','NA'),
    ('AU194','Wuhan University','Q194','NA','NA'),
    ('AU195','Macquarie University','Q195','NA','NA'),
    ('AU196','Université catholique de Louvain (UCLouvain)','Q196','NA','T171'),
    ('AU197','Keio University','Q197','C34','NA'),
    ('AU198','Ulsan National Institute of Science and Technology (UNIST)','Q198','NA','NA'),
    ('AU199','Vanderbilt University','Q199','C69','T87'),
    ('AU200','Technische Universität Dresden','Q200','NA','NA');
...
INSERT INTO Discussion(discussionId,discussionContent, usersInDiscussion, university) VALUES
    (1,'Is this a good university','SU0001','AU001'),
    (2,'This is the best school','SU0001','AU001'),
    (3,'Is this a good university','SU0003','AU003'),
    (4,'This is the best school','SU0004','AU004'),
    (5,'Is this a good university','SU0005','AU005'),
    (6,'This is the best school','SU0006','AU006'),
    (7,'This is the best school','UU0002','AU052'),
    (8,'Is this a good university','UU0003','AU053'),
    (9,'This is the best school','UU0004','AU054');

INSERT INTO Events(eventCode, eventName, eventDate, location, createrId, university) VALUES (1,'School is Back','2023-09-23 06:48:50','zoom.ca','UU0001','AU001');
INSERT INTO Events(eventCode, eventName, eventDate, location, createrId, university) VALUES (2,'Back to the Class','2023-09-20 13:01:28','zoom.ca','UU0002','AU002');
INSERT INTO Events(eventCode, eventName, eventDate, location, createrId, university) VALUES (3,'Homework is Done','2024-01-23 09:59:23','zoom.ca','UU0003','AU001');
INSERT INTO Events(eventCode, eventName, eventDate, location, createrId, university) VALUES (4,'Bag is Set','2024-02-02 18:48:20','zoom.ca','UU0001','AU003');
INSERT INTO Events(eventCode, eventName, eventDate, location, createrId, university) VALUES (5,'Nerds Night Out','2023-05-01 09:53:01','zoom.ca','UU0002','AU001');
